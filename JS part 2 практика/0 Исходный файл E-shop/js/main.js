 ...
 let cart = {
     ...
     addProduct(product) {
         // добавил 3 строки ниже - для отображения карптинок в корзине
         let parentElement = product.parentElement;
         let namePosition = parentElement.querySelector("h1").innerHTML;
         let indexPosition = PRODUCTS_NAMES.indexOf(namePosition);
         //
         ...
         if (find) {
             ...
             let prod = this._createNewProduct(product, indexPosition)
